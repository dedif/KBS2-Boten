...
namespace UnitTestProject2
{
    ...
    public class UnitTestDamage
    {
        ...
        public void AlreadyReserved_AlreadyReserved_ReservedIsFilled(string boatName, string answer)
        {
            ...
            //maak boot
            Boat boatTest = new Boat(boatName, Boat.BoatType.Board, 2, 2, false,3, DateTime.Now, DateTime.Now);
        ...
        {
            //Arrange
            Boat boatTest = new Boat("bootTest", Boat.BoatType.Board, 2, 2,false, 3, DateTime.Now, DateTime.Now);
